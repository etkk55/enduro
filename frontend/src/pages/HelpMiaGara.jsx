  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-surface border border-border-subtle rounded-lg p-5 shadow-sm">
        ...
        {/* Grafico Posizioni */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-content-secondary mb-4">📈 Andamento Posizioni</h3>
          ...
          <div className="bg-brand-50 dark:bg-brand-100 rounded-lg p-4">
        ...
        {/* Grafico Scostamenti */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-content-secondary mb-4">⏱️ Scostamenti Tempi PS</h3>
          <p className="text-lg text-content-secondary mb-4">
          ...
          <div className="bg-surface-2 rounded-md p-4 mb-4">
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span className="text-lg text-content-secondary">= più veloce della mediana</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-xl text-red-600 font-bold">↓ Sotto lo 0</span>
                <span className="text-lg text-content-secondary">= più lento della mediana</span>
              </li>
            </ul>
          </div>
        ...
        {/* Grafico Cumulato */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-content-secondary mb-4">📊 Differenza Cumulata</h3>
          <p className="text-lg text-content-secondary mb-4">
          ...
          <div className="bg-surface-2 rounded-md p-4 mb-4">
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span className="text-lg text-content-secondary">= accumula vantaggio (costantemente più veloce)</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-xl text-red-600 font-bold">Linea in basso</span>
                <span className="text-lg text-content-secondary">= accumula ritardo (costantemente più lento)</span>
              </li>
            </ul>
          </div>
        ...
        {/* Selezione Piloti */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-content-secondary mb-4">👥 Selezione Piloti da Confrontare</h3>
          <div className="bg-surface-2 rounded-md p-4">
            <p className="font-medium text-lg text-content-secondary mb-3">Due modalità disponibili:</p>
            <ul className="space-y-4">
              <li>
                <span className="font-medium text-lg text-content-secondary">Vicini in classifica finale:</span>
                <span className="text-lg text-content-secondary"> Seleziona automaticamente i 3 piloti sopra e 3 sotto di te nella classifica finale.</span>
              </li>
              <li>
                <span className="font-medium text-lg text-content-secondary">Seleziona piloti:</span>
                <span className="text-lg text-content-secondary"> Digita il cognome per cercare e selezionare manualmente fino a 6 piloti da confrontare.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Legenda Colori */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-content-secondary mb-4">🎨 Legenda Colori</h3>
          <div className="bg-surface-2 rounded-md p-4">
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                <span className="w-6 h-6 rounded" style={{backgroundColor: '#1f77b4'}}></span>
                <span className="text-lg text-content-secondary font-medium">Blu = TU (la tua linea)</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="text-lg text-content-secondary">Verde/Azzurro/Viola = piloti davanti a te</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span className="text-lg text-content-secondary">Rosso/Arancione/Giallo = piloti dietro a te</span>
              </li>
            </ul>
          </div>
        </div>
